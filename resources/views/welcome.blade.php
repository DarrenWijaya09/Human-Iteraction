...
<body class="bg-gray-50 font-sans antialiased">
                        ...
                        @auth
                            ...
                            <div class="relative">
                                <button id="profileButton"
                                    ...
                                    <!-- Avatar -->
                                    <div class="w-8 h-8 rounded-full overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center">
                                        @if(Auth::user()->avatar)
                                ...
                                <div id="profileDropdown"
                                    ...
                                    <div class="p-4 border-b border-gray-100">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xl overflow-hidden">
                                                @if(Auth::user()->avatar)
                                                    <img src="{{ asset('storage/' . Auth::user()->avatar) }}"
                                                         alt="{{ Auth::user()->name }}"
                                                         class="w-full h-full object-cover">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <span class="inline-block mt-1 text-[10px] bg-green-100 text-green-600 px-2 py-0.5 rounded-full">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">Rekomendasi Untukmu</a></li>
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">Promo Hari Ini</a></li>
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">Produk Tren</a></li>
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">Voucher & Diskon</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="font-semibold text-gray-800 mb-4">Bantuan</h3>
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">Bantuan dan Panduan</a></li>
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">Ruang Edukasi Vexora</a></li>
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">Hak Kekayaan Intelektual</a></li>
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">Kebijakan Privasi</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="font-semibold text-gray-800 mb-4">Layanan</h3>
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">Vexora Profile</a></li>
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">Digital Products</a></li>
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">IT Services</a></li>
                            <li><a href="#" class="text-gray-500 hover:text-blue-600 transition-all duration-300">Forum Komunitas</a></li>
                        </ul>
                    </div>
                </div>
                <div class="border-t border-gray-200 mt-8 pt-6 text-center text-sm text-gray-400">
                    <p>&copy; {{ date('Y') }} VEXORA. All rights reserved. Marketplace digital terpercaya di Indonesia.</p>
                </div>
            </div>
        </footer>
    </div>
    ...
    <script>
        ...
        const forUserProducts = [
            { name: "MacBook Pro 14\" M3", price: 22999000, rating: 4.8, sold: 1243, badge: null },
            { name: "VEXORA Wireless Mouse", price: 125000, rating: 4.5, sold: 892, badge: null },
            { name: "Mechanical Keyboard RGB", price: 589000, rating: 4.7, sold: 543, badge: null },
            { name: "USB-C Hub 8-in-1", price: 299000, rating: 4.6, sold: 2100, badge: null },
            { name: "Monitor 27\" 4K", price: 3899000, rating: 4.9, sold: 421, badge: null },
            { name: "SSD External 1TB", price: 1250000, rating: 4.7, sold: 675, badge: null },
            { name: "Webcam Full HD", price: 450000, rating: 4.3, sold: 352, badge: null },
            { name: "VEXORA Smartwatch", price: 789000, rating: 4.4, sold: 1520, badge: null },
            { name: "Laptop Stand Aluminium", price: 199000, rating: 4.8, sold: 3400, badge: null },
            { name: "Power Bank 20000mAh", price: 325000, rating: 4.6, sold: 2780, badge: null }
        ];

        const trenProducts = [
            { name: "iPhone 15 Pro Max", price: 18999000, rating: 4.9, sold: 3421, badge: "🔥 Hot" },
            { name: "VEXORA TWS Earbuds", price: 459000, rating: 4.8, sold: 5680, badge: "🎧 Trending" },
            { name: "Smart Home Camera", price: 599000, rating: 4.5, sold: 1734, badge: null },
            { name: "Drone Mini 4K", price: 2450000, rating: 4.7, sold: 890, badge: "✨ New" },
            { name: "VEXORA Backpack", price: 379000, rating: 4.8, sold: 2230, badge: null },
            { name: "GPU RTX 4060", price: 4999000, rating: 4.9, sold: 450, badge: "Gaming" }
        ];

        const promoProducts = [
            { name: "VEXORA Hoodie Exclusive", price: 99000, originalPrice: 299000, rating: 4.6, sold: 1245, badge: "Diskon 67%" },
            { name: "Smart Band 7", price: 199000, originalPrice: 499000, rating: 4.5, sold: 2780, badge: "60% OFF" },
            { name: "Wireless Charger Pad", price: 89000, originalPrice: 199000, rating: 4.4, sold: 3450, badge: "Flash Sale" },
            { name: "VEXORA Mousepad XL", price: 45000, originalPrice: 99000, rating: 4.7, sold: 5412, badge: "Hari Ini" }
        ];
        ...
        function renderProducts(products, isPromo = false) {
            ...
            products.forEach(prod => {
                ...
                const badgeHtml = prod.badge ? `<span class="absolute top-2 left-2 bg-red-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full z-10 shadow">${prod.badge}</span>` : '';

                let priceExtraHtml = '';
                if (isPromo && prod.originalPrice) {
                    const formattedOriginal = new Intl.NumberFormat('id-ID').format(prod.originalPrice);
                    priceExtraHtml = `<span class="text-xs text-gray-400 line-through ml-2">Rp ${formattedOriginal}</span>`;
                }

                const card = document.createElement('div');
                card.className = 'group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:scale-[1.02]';
                card.innerHTML = `
                    <div class="relative">
                        ${badgeHtml}
